...
const FAQ: React.FC = () => (
  <div className="max-w-2xl mx-auto py-10 px-4">
    <head>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "mainEntity": [
          ...
          {"@type": "Question","name": "Is TwoZeroFourEight free to play?","acceptedAnswer": {"@type": "Answer","text": "Yes, our 2048 game is completely free to play with no sign-up required."}},
          ...
          {"@type": "Question","name": "How can I contact support?","acceptedAnswer": {"@type": "Answer","text": "Visit our Contact page or email us at [your@email.com]."}},
    ...
    <div className="space-y-6">
      ...
      <div>
        <h2 className="font-semibold">Is TwoZeroFourEight free to play?</h2>
      ...
      <div>
        ...
        <p>Visit our Contact page or email us at [your@email.com].</p>
      </div>
      <div>
